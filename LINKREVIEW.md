...
| Intrincis Dimension | Persistent Homology and the Upper Box Dimension | 2021| B. Schweinhart. | [arXiv](https://arxiv.org/abs/1802.00533) |  | Теоретические основы PHD. Вводится для метрических пространств через экстремальные подмножества. |
